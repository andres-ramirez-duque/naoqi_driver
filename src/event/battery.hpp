...
#ifndef BATTERY_EVENT_REGISTER_HPP
#define BATTERY_EVENT_REGISTER_HPP
...
// Converter
#include "../src/converters/battery.hpp"
// Publisher
...
public:
  ...
  */
  BatteryEventRegister();
  BatteryEventRegister(const std::string& key, const qi::SessionPtr& session, boost::shared_ptr<tobo_planner::action_chain>& msg );
  ~BatteryEventRegister();
...
private:
  ...
  void onEvent(qi::AnyValue &value);

private:
  boost::shared_ptr<converter::BatteryEventConverter> converter_;
