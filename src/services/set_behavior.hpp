...
#ifndef SET_BEHAVIOR_SERVICE_HPP
#define SET_BEHAVIOR_SERVICE_HPP
...
class SetBehaviorService
{
public:
  SetBehaviorService( const std::string& name, const std::string& topic, const qi::SessionPtr& session );
