...
#ifndef SET_ANIMATION_SERVICE_HPP
#define SET_ANIMATION_SERVICE_HPP
...
class SetAnimationService
{
public:
  SetAnimationService( const std::string& name, const std::string& topic, const qi::SessionPtr& session );
