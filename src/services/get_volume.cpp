...
namespace service
{
  ...
  bool GetVolumeService::callback( naoqi_bridge_msgs::GetFloatRequest& req, naoqi_bridge_msgs::GetFloatResponse& resp )
  {
    resp.data = helpers::driver::getVolume(session_);
    resp.message = "Volume Data returned";
    return true;
  }
