...
#ifndef SET_ALIVENESS_SERVICE_HPP
#define SET_ALIVENESS_SERVICE_HPP
...
class SetAlivenessService
{
public:
  SetAlivenessService( const std::string& name, const std::string& topic, const qi::SessionPtr& session );
