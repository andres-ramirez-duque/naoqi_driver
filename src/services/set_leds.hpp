...
#ifndef SET_LEDS_SERVICE_HPP
#define SET_LEDS_SERVICE_HPP
...
class SetLedsService
{
public:
  SetLedsService( const std::string& name, const std::string& topic, const qi::SessionPtr& session );
