...
#ifndef SET_WAKEUP_SERVICE_HPP
#define SET_WAKEUP_SERVICE_HPP
...
class SetWakeupService
{
public:
  SetWakeupService( const std::string& name, const std::string& topic, const qi::SessionPtr& session );
